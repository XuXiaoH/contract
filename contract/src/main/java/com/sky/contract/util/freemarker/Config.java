package com.sky.contract.util.freemarker;

import com.jagregory.shiro.freemarker.ShiroTags;
import com.sky.contract.util.cons.ParamConvert;
...
public class Config {
     ...
     */
    @Bean
    public CommandLineRunner customFreemarkerTemplateLoader(freemarker.template.Configuration configuration) {
        return strings -> {
